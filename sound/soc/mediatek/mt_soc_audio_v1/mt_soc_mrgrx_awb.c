...
#define MAX_PERIOD_SIZE     MRGRX_MAX_BUFFER_SIZE
...
static snd_pcm_uframes_t mtk_awb_pcm_pointer(struct snd_pcm_substream *substream)
{
	...
	if (Mrgrx_AWB_Control_context->interruptTrigger == 1) {
		...
		Mrgrx_AWB_Control_context->interruptTrigger = 0;
...
static unsigned int mrgrx_awb_supported_sample_rates[] = {
	8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000
};

static struct snd_pcm_hw_constraint_list mrgrx_awb_constraints_sample_rates = {
	.count = ARRAY_SIZE(mrgrx_awb_supported_sample_rates),
	.list = mrgrx_awb_supported_sample_rates,
};
