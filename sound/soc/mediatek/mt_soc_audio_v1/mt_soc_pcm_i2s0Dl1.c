...
/* defaults */
#define I2S0dl1_MAX_BUFFER_SIZE     (24*1024)
#define MIN_PERIOD_SIZE       64
#define MAX_PERIOD_SIZE     I2S0dl1_MAX_BUFFER_SIZE
#define I2S0Dl1_USE_FORMATS  (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S16_BE | SNDRV_PCM_FMTBIT_U16_LE | SNDRV_PCM_FMTBIT_U16_BE| \
...
static struct snd_pcm_hardware mtk_I2S0dl1_hardware = {
	...
	.formats = I2S0Dl1_USE_FORMATS,
	.rates = USE_RATE,
	.rate_min = USE_RATE_MIN,
	.rate_max = USE_RATE_MAX,
	.channels_min = USE_CHANNELS_MIN,
	.channels_max = USE_CHANNELS_MAX,
	.buffer_bytes_max = I2S0dl1_MAX_BUFFER_SIZE,
...
static unsigned int I2S0dl1_supported_sample_rates[] = {
	8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000, 88200, 96000, 192000
};

static struct snd_pcm_hw_constraint_list constraints_sample_rates = {
	.count = ARRAY_SIZE(I2S0dl1_supported_sample_rates),
	.list = I2S0dl1_supported_sample_rates,
	.mask = 0,
};
				...
				void __user *dst, snd_pcm_uframes_t count)
{
	...
	unsigned int *temp_buffer = (unsigned int *)dst;
