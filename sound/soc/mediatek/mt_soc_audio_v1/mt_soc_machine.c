				     ...
				     size_t count, loff_t *pos)
{
	...
	n += scnprintf(buffer + n, size - n, "AFE_MAD_TOP  = 0x%x\n", Ana_Get_Reg(AFE_MAD_TOP));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_CFG0  = 0x%x\n", Ana_Get_Reg(AFE_MAD_CFG0));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_CFG1  = 0x%x\n", Ana_Get_Reg(AFE_MAD_CFG1));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_CFG2  = 0x%x\n", Ana_Get_Reg(AFE_MAD_CFG2));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_CFG3  = 0x%x\n", Ana_Get_Reg(AFE_MAD_CFG3));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_CFG4  = 0x%x\n", Ana_Get_Reg(AFE_MAD_CFG4));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_CFG5  = 0x%x\n", Ana_Get_Reg(AFE_MAD_CFG5));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_MON0  = 0x%x\n", Ana_Get_Reg(AFE_MAD_MON0));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_MON1  = 0x%x\n", Ana_Get_Reg(AFE_MAD_MON1));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_MON2  = 0x%x\n", Ana_Get_Reg(AFE_MAD_MON2));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_MON3  = 0x%x\n", Ana_Get_Reg(AFE_MAD_MON3));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_MON4  = 0x%x\n", Ana_Get_Reg(AFE_MAD_MON4));
	n += scnprintf(buffer + n, size - n, "AFE_MAD_MON5  = 0x%x\n", Ana_Get_Reg(AFE_MAD_MON5));
