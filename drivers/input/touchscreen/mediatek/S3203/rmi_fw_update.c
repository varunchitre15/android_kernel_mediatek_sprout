...
int synaptics_fw_version_updater()
{
    ...
    sprintf(tpd_desc, "JieMian-S9121-S3202-%d", tpd_fw_version);
         }
    ////////////////////////////////////////////////////////////////////////////
    return retval;
}
...
EXPORT_SYMBOL(synaptics_fw_updater_s3203);
        ...
        char *buf, loff_t pos, size_t count)
{
    ...
    fwu->data_pos += count;
      ...
      TPD_DMESG("fwu_sysfs_store_image count=%d  fwu->data_pos =%d \n",count,fwu->data_pos);
    return count;
}
        ...
        struct device_attribute *attr, const char *buf, size_t count)
{
    ...
    fwu->data_pos = 0;
       ...
       TPD_DMESG("fwu_sysfs_image_size_store fwu->image_size = %d \n",fwu->image_size);
...
{
    synaptics_rmi4_new_function_s3203(RMI_FW_UPDATER, true,
...
static void __exit rmi4_fw_update_module_exit(void)
{
    ...
    synaptics_rmi4_new_function_s3203(RMI_FW_UPDATER, false,
            synaptics_rmi4_fwu_init,
            synaptics_rmi4_fwu_remove,
            synaptics_rmi4_fwu_attn);
