...
extern unsigned int *mt6582_power_gs_tdd_paging;
extern unsigned int mt6582_power_gs_tdd_paging_len;
...
void mt_power_gs_dump_tdd_paging(void)
{
    mt_power_gs_compare("TDD Paging",                                               \
                        mt6582_power_gs_tdd_paging, mt6582_power_gs_tdd_paging_len, \
...
MODULE_DESCRIPTION("MT6582 Power Golden Setting - TDD Paging");
