...
extern unsigned int *mt6582_power_gs_3g_talking;
extern unsigned int mt6582_power_gs_3g_talking_len;
...
void mt_power_gs_dump_3g_talking(void)
{
    mt_power_gs_compare("3G Talking",                                               \
                        mt6582_power_gs_3g_talking, mt6582_power_gs_3g_talking_len, \
...
MODULE_DESCRIPTION("MT6582 Power Golden Setting - 3G Talking");
