...
extern unsigned int *mt6582_power_gs_tdd_talking;
extern unsigned int mt6582_power_gs_tdd_talking_len;
...
void mt_power_gs_dump_tdd_talking(void)
{
    mt_power_gs_compare("TDD Talking",                                                \
                        mt6582_power_gs_tdd_talking, mt6582_power_gs_tdd_talking_len, \
...
MODULE_DESCRIPTION("MT6582 Power Golden Setting - TDD Talking");
