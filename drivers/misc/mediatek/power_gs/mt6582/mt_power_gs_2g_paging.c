...
extern unsigned int *mt6582_power_gs_2g_paging;
extern unsigned int mt6582_power_gs_2g_paging_len;
...
MODULE_DESCRIPTION("MT6582 Power Golden Setting - 2G Paging");
