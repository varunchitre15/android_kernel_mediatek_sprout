...
#ifndef CONFIG_MTK_MT8193_HDMI_SUPPORT
...
/*static*/ void hdmi_resume(void)
{
    ...
    hdmi_drv->resume();
#if 0 // !defined(CONFIG_MTK_MT8193_HDMI_SUPPORT)
...
#if (defined(CONFIG_MTK_TEE_SUPPORT) && defined(CONFIG_MTK_HDMI_HDCP_SUPPORT)&&defined(CONFIG_MTK_DRM_KEY_MNG_SUPPORT))
