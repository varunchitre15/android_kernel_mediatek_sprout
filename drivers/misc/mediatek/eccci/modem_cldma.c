...
static void cldma_dump_gpd_ring(void *start)
{
	...
	int i, *tmp;
	CCCI_DUMP_COM_MSG("[CLDMA] gpd starts from %p\n", start);
	/*
...
static void cldma_dump_all_gpd(struct md_cd_ctrl *md_ctrl)
{
	...
	for (i = 0; i < QUEUE_LEN(md_ctrl->txq); i++) {
		...
		CCCI_DUMP_COM_MSG("[CLDMA] dump txq %d GPD\n", i);
...
static void cldma_dump_register(struct md_cd_ctrl *md_ctrl)
{
	...
	CCCI_DUMP_COM_MSG("[CLDMA] dump AP CLDMA Tx register\n");
