...
void GC0313MIPI_Sensor_Init(void)
{
	...
	GC0313MIPI_write_cmos_sensor(0x95 , 0x86); 
	...
	GC0313MIPI_write_cmos_sensor(0xd1 , 0x38);
	GC0313MIPI_write_cmos_sensor(0xd2 , 0x38);
	GC0313MIPI_write_cmos_sensor(0xd3 , 0x40);
