...
int hdmi_drv_power_on(void)
{
...
#else
	pr_debug("%s,%d Error: CUST_EINT_MHL_NUM is not defined\n", __func__, __LINE__);
#endif
	...
	pr_debug("MHL hdmi_drv_power_on status %d,chipid: %X, ret: %d\n",
