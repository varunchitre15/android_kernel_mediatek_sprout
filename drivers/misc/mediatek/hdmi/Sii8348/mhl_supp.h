...
uint8_t si_mhl_tx_set_preferred_pixel_format(struct mhl_dev_context *dev_context, uint8_t clkMode);
...
void si_mhl_tx_enable_hdcp(struct mhl_dev_context *dev_context, enum hdcp_state);
