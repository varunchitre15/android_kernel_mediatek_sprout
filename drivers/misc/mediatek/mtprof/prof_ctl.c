...
#define MAX_TIME 30*60	// max debug time, if reach the level, stop and clear the debug information

#else

#define MAX_THREAD_COUNT 3000	// max debug thread count, if reach the level, stop store new thread informaiton.
#define MAX_TIME 15*60	// max debug time, if reach the level, stop and clear the debug information
