...
//OutDoor  BLC
HI258_write_cmos_sensor(0x99, 0x46); //R,Gr,B,Gb Offset

//Dark BLC
HI258_write_cmos_sensor(0xa0, 0x43); //R,Gr,B,Gb Offset

//Normal BLC
HI258_write_cmos_sensor(0xa8, 0x44); //R,Gr,B,Gb Offset
///// PAGE 0 END /////
...
//Outdoor Slope
HI258_write_cmos_sensor(0xb6, 0x18); //Lum negative Hi
HI258_write_cmos_sensor(0xb7, 0x20); //Lum negative middle
HI258_write_cmos_sensor(0xb8, 0x14); //Lum negative Low
HI258_write_cmos_sensor(0xb9, 0x28); //Lum postive Hi
HI258_write_cmos_sensor(0xba, 0x20); //Lum postive middle
HI258_write_cmos_sensor(0xbb, 0x14); //Lum postive Low

//Indoor Slope
HI258_write_cmos_sensor(0xbc, 0x18); //Lum negative Hi
HI258_write_cmos_sensor(0xbd, 0x20); //Lum negative middle
HI258_write_cmos_sensor(0xbe, 0x14); //Lum negative Low
HI258_write_cmos_sensor(0xbf, 0x18); //Lum postive Hi
HI258_write_cmos_sensor(0xc0, 0x20); //Lum postive middle
HI258_write_cmos_sensor(0xc1, 0x14); //Lum postive Low

//Dark Slope
HI258_write_cmos_sensor(0xc2, 0x14); //Lum negative Hi
HI258_write_cmos_sensor(0xc3, 0x14); //Lum negative middle
HI258_write_cmos_sensor(0xc4, 0x1d); //Lum negative Low
HI258_write_cmos_sensor(0xc5, 0x14); //Lum postive Hi
HI258_write_cmos_sensor(0xc6, 0x14); //Lum postive middle
...
*/
HI258_write_cmos_sensor(0x30, 0x8e);
HI258_write_cmos_sensor(0x31, 0x83);
HI258_write_cmos_sensor(0x32, 0x31);
HI258_write_cmos_sensor(0x33, 0x13);
HI258_write_cmos_sensor(0x34, 0x5a);
HI258_write_cmos_sensor(0x35, 0x05);
HI258_write_cmos_sensor(0x36, 0x05);
HI258_write_cmos_sensor(0x37, 0x3e);
HI258_write_cmos_sensor(0x38, 0x83);
...
HI258_write_cmos_sensor(0x70, 0x45); //6c
HI258_write_cmos_sensor(0x71, 0x8a); //81(+4),89(-4)
...
HI258_write_cmos_sensor(0x85, 0x4c);
HI258_write_cmos_sensor(0x86, 0x01); //EXPMin 21812.08 fps
HI258_write_cmos_sensor(0x87, 0x2a);
HI258_write_cmos_sensor(0x88, 0x09); //EXP Max 60hz 10 fps
HI258_write_cmos_sensor(0x89, 0xe0);
HI258_write_cmos_sensor(0x8a, 0x58);
HI258_write_cmos_sensor(0xa5, 0x09); //EXP Max 50hz 10fps
HI258_write_cmos_sensor(0xa6, 0xe9);
HI258_write_cmos_sensor(0xa7, 0xa8);
HI258_write_cmos_sensor(0x8B, 0xfd); //EXP100
HI258_write_cmos_sensor(0x8C, 0xc4);
HI258_write_cmos_sensor(0x8D, 0xd2); //EXP120
HI258_write_cmos_sensor(0x8E, 0xb2);
HI258_write_cmos_sensor(0x9c, 0x10); //EXP Limit 816.33 fps
HI258_write_cmos_sensor(0x9d, 0x4c);
HI258_write_cmos_sensor(0x9e, 0x01); //EXP Unit
HI258_write_cmos_sensor(0x9f, 0x2a);
...
HI258_write_cmos_sensor(0x24, 0x12);
HI258_write_cmos_sensor(0x25, 0x22);
HI258_write_cmos_sensor(0x26, 0x22);
HI258_write_cmos_sensor(0x27, 0x21);
HI258_write_cmos_sensor(0x28, 0x12);
HI258_write_cmos_sensor(0x29, 0x55);
HI258_write_cmos_sensor(0x2a, 0x55);
HI258_write_cmos_sensor(0x2b, 0x21);
HI258_write_cmos_sensor(0x2c, 0x12);
HI258_write_cmos_sensor(0x2d, 0x57);
HI258_write_cmos_sensor(0x2e, 0x75);
HI258_write_cmos_sensor(0x2f, 0x21);
HI258_write_cmos_sensor(0x30, 0x12);
HI258_write_cmos_sensor(0x31, 0x57);
HI258_write_cmos_sensor(0x32, 0x75);
HI258_write_cmos_sensor(0x33, 0x21);
HI258_write_cmos_sensor(0x34, 0x12);
HI258_write_cmos_sensor(0x35, 0x55);
HI258_write_cmos_sensor(0x36, 0x55);
HI258_write_cmos_sensor(0x37, 0x21);
HI258_write_cmos_sensor(0x38, 0x12);
HI258_write_cmos_sensor(0x39, 0x22);
HI258_write_cmos_sensor(0x3a, 0x22);
HI258_write_cmos_sensor(0x3b, 0x21);
...
HI258_write_cmos_sensor(0x44, 0x12);
HI258_write_cmos_sensor(0x45, 0x22);
HI258_write_cmos_sensor(0x46, 0x22);
HI258_write_cmos_sensor(0x47, 0x21);
HI258_write_cmos_sensor(0x48, 0x12);
HI258_write_cmos_sensor(0x49, 0x55);
HI258_write_cmos_sensor(0x4a, 0x55);
HI258_write_cmos_sensor(0x4b, 0x21);
HI258_write_cmos_sensor(0x4c, 0x12);
HI258_write_cmos_sensor(0x4d, 0x57);
HI258_write_cmos_sensor(0x4e, 0x75);
HI258_write_cmos_sensor(0x4f, 0x21);
HI258_write_cmos_sensor(0x50, 0x12);
HI258_write_cmos_sensor(0x51, 0x57);
HI258_write_cmos_sensor(0x52, 0x75);
HI258_write_cmos_sensor(0x53, 0x21);
HI258_write_cmos_sensor(0x54, 0x12);
HI258_write_cmos_sensor(0x55, 0x55);
HI258_write_cmos_sensor(0x56, 0x55);
HI258_write_cmos_sensor(0x57, 0x21);
HI258_write_cmos_sensor(0x58, 0x12);
HI258_write_cmos_sensor(0x59, 0x22);
HI258_write_cmos_sensor(0x5a, 0x22);
HI258_write_cmos_sensor(0x5b, 0x21);
...
void HI258_night_mode(kal_bool enable)
{
    ...
    if (enable)
    {
        ...
        if (HI258_Banding_setting == AE_FLICKER_MODE_50HZ)
        {
            ...
            HI258_write_cmos_sensor(0x89, 0xc0);
            HI258_write_cmos_sensor(0x8a, 0xb0);

                    //EXP Max 50hz
            HI258_write_cmos_sensor(0xa5, 0x13); //EXP Max 5 fps
            HI258_write_cmos_sensor(0xa6, 0xd3);
            HI258_write_cmos_sensor(0xa7, 0x50);
    ...
    else
    {
        ...
        if (HI258_Banding_setting == AE_FLICKER_MODE_50HZ)
        {
            ...
            HI258_write_cmos_sensor(0x87, 0x2a);
                  //EXP Max 60hz
            HI258_write_cmos_sensor(0x88, 0x09); //EXP Max 10 fps
            HI258_write_cmos_sensor(0x89, 0xe0);
            HI258_write_cmos_sensor(0x8a, 0x58);

                    //EXP Max 50hz
            HI258_write_cmos_sensor(0xa5, 0x09); //EXP Max 10 fps
            HI258_write_cmos_sensor(0xa6, 0xe9);
            HI258_write_cmos_sensor(0xa7, 0xa8);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    HI258_write_cmos_sensor(0x9c, 0x10); //EXP Limit 1083.33fps
    HI258_write_cmos_sensor(0x9d, 0x4c);
    HI258_write_cmos_sensor(0x9e, 0x01); //EXP Unit
    HI258_write_cmos_sensor(0x9f, 0x2a);
    HI258_write_cmos_sensor(0xa3, 0x00); //EXP Unit
    HI258_write_cmos_sensor(0xa4, 0xd2);
...
BOOL HI258_set_param_banding(UINT16 para)
{
    ...
    HI258_write_cmos_sensor(0x83, 0x09);//EXP Normal 8.00 fps
    HI258_write_cmos_sensor(0x84, 0xe9);
    HI258_write_cmos_sensor(0x85, 0xa8);
    ...
    HI258_write_cmos_sensor(0x83, 0x09); //EXP Normal 8.00 fps
    HI258_write_cmos_sensor(0x84, 0xe0);
    HI258_write_cmos_sensor(0x85, 0x58);
                             ...
                             UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ: // for KK branch unit using Mhz 
            *pFeatureReturnPara32 = (HI258_sensor_pclk/10)*1000000;
            *pFeatureParaLen=4;
            break;
