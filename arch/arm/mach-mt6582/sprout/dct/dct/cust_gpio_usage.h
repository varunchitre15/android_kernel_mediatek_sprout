...
#define GPIO_OTG_IDDIG_EINT_PIN            (gpio_usage->otg_iddig_eint_pin | 0x80000000)
#define GPIO_OTG_IDDIG_EINT_PIN_M_GPIO            gpio_usage->otg_iddig_eint_pin_m_gpio
#define GPIO_OTG_IDDIG_EINT_PIN_M_CLK            gpio_usage->otg_iddig_eint_pin_m_clk
#define GPIO_OTG_IDDIG_EINT_PIN_M_UCTS            gpio_usage->otg_iddig_eint_pin_m_ucts
#define GPIO_OTG_IDDIG_EINT_PIN_M_CLKM            gpio_usage->otg_iddig_eint_pin_m_clkm
#define GPIO_OTG_IDDIG_EINT_PIN_M_IDDIG            gpio_usage->otg_iddig_eint_pin_m_iddig
#define GPIO_OTG_IDDIG_EINT_PIN_M_DBG_MON_B            gpio_usage->otg_iddig_eint_pin_m_dbg_mon_b
#define GPIO_OTG_IDDIG_EINT_PIN_CLK            gpio_usage->otg_iddig_eint_pin_clk
#define GPIO_OTG_IDDIG_EINT_PIN_FREQ            gpio_usage->otg_iddig_eint_pin_freq
...
#define GPIO_UART_UCTS1_PIN_M_UCTS            gpio_usage->uart_ucts1_pin_m_ucts
#define GPIO_UART_UCTS1_PIN_M_CLKM            gpio_usage->uart_ucts1_pin_m_clkm
#define GPIO_UART_UCTS1_PIN_M_IDDIG            gpio_usage->uart_ucts1_pin_m_iddig
#define GPIO_UART_UCTS1_PIN_M_DBG_MON_B            gpio_usage->uart_ucts1_pin_m_dbg_mon_b
...
#define GPIO_UART_UCTS2_PIN_M_UCTS            gpio_usage->uart_ucts2_pin_m_ucts
...
#define GPIO_OTG_DRVVBUS_PIN            (gpio_usage->otg_drvvbus_pin | 0x80000000)
#define GPIO_OTG_DRVVBUS_PIN_M_GPIO            gpio_usage->otg_drvvbus_pin_m_gpio
#define GPIO_OTG_DRVVBUS_PIN_M_KROW            gpio_usage->otg_drvvbus_pin_m_krow
#define GPIO_OTG_DRVVBUS_PIN_M_DRV_VBUS            gpio_usage->otg_drvvbus_pin_m_drv_vbus
#define GPIO_OTG_DRVVBUS_PIN_M_DBG_MON_A            gpio_usage->otg_drvvbus_pin_m_dbg_mon_a
